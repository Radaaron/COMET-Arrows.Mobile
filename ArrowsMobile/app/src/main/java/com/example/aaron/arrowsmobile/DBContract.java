...
public final class DBContract {
    ...
    // create
    public static final String CREATE_TABLE_ACADEMIC_PERIOD = "CREATE TABLE " + AcademicPeriod.TABLE_ACADEMIC_PERIOD + " ("
            + AcademicPeriod.COLUMN_PERIOD_ID + " VARCHAR PRIMARY KEY, " + AcademicPeriod.COLUMN_PERIOD + " VARCHAR, "
            + AcademicPeriod.COLUMN_AY_START + " INTEGER, " + AcademicPeriod.COLUMN_AY_END + " INTEGER, "
            + AcademicPeriod.COLUMN_START_DATE + " DATETIME, " + AcademicPeriod.COLUMN_END_DATE + " DATETIME" + " )";

    public static final String CREATE_TABLE_CAN_DRIVE = "CREATE TABLE " + CanDrive.TABLE_CAN_DRIVE + " (" + CanDrive.COLUMN_MODEL
            + " VARCHAR PRIMARY KEY )";
    ...
    public static final String CREATE_TABLE_CLASS_SCHEDULE = "CREATE TABLE " + ClassSchedule.TABLE_CLASS_SCHEDULE + " (" + ClassSchedule.COLUMN_SCHED_ID + " INTEGER PRIMARY KEY, "
            + ClassSchedule.COLUMN_AY + " VARCHAR, " + ClassSchedule.COLUMN_COURSE_CODE + " VARCHAR, " + ClassSchedule.COLUMN_START_TIME
            + " DATETIME, " + ClassSchedule.COLUMN_END_TIME + " DATETIME, " + ClassSchedule.COLUMN_TERM + " INTEGER, " + ClassSchedule.COLUMN_DAY
            + " VARCHAR, " + ClassSchedule.COLUMN_SECTION + " VARCHAR, " + ClassSchedule.COLUMN_ROOM + " VARCHAR )";

    public static final String CREATE_TABLE_DRIVER = "CREATE TABLE " + Driver.TABLE_DRIVER + " (" + Driver.COLUMN_DRIVER_ID + " INTEGER PRIMARY KEY, "
            + Driver.COLUMN_LAST_NAME + " VARCHAR, " + Driver.COLUMN_FIRST_NAME + " VARCHAR, " + Driver.COLUMN_NICKNAME + " VARCHAR )";

    public static final String CREATE_TABLE_LINE = "CREATE TABLE " + Line.TABLE_LINE + " (" + Line.COLUMN_LINE_NUM + " INTEGER PRIMARY KEY, "
            + Line.COLUMN_LINE_NAME + " VARCHAR )";

    public static final String CREATE_TABLE_PASSENGER = "CREATE TABLE " + Passenger.TABLE_PASSENGER + " (" + Passenger.COLUMN_PASSENGER_ID + " INTEGER PRIMARY KEY, "
            + Passenger.COLUMN_FEEDBACK_ON + " VARCHAR, " + Passenger.COLUMN_FEEDBACK + " INTEGER, " + Passenger.COLUMN_TAP_IN + " DATETIME, " + Passenger.COLUMN_TAP_OUT
            + " DATETIME, " + Passenger.COLUMN_DISEMBARKATION_PT + " VARCHAR, " + Passenger.COLUMN_DESTINATION + " VARCHAR, " + Passenger.COLUMN_IS_CHANCE + " BOOLEAN )";

    public static final String CREATE_TABLE_RESERVATION = "CREATE TABLE " + Reservation.TABLE_RESERVATION + " (" + Reservation.COLUMN_RESERVATION_NUM + " VARCHAR PRIMARY KEY, "
            + Reservation.COLUMN_TIMESTAMP + " DATETIME, " + Reservation.COLUMN_DESTINATION + " VARCHAR, " + Reservation.COLUMN_REMARK + " VARCHAR )";

    public static final String CREATE_TABLE_ROUTE = "CREATE TABLE " + Route.TABLE_ROUTE + " (" + Route.COLUMN_ROUTE_ID + " INTEGER PRIMARY KEY, " + Route.COLUMN_ROUTE_NAME
            + " VARCHAR, " + Route.COLUMN_ROUTE_DESCRIPTION + " VARCHAR )";

    public static final String CREATE_TABLE_ROUTE_STOP = "CREATE TABLE " + RouteStop.TABLE_ROUTE_STOP + " (" + RouteStop.COLUMN_STOP_NUM + " VARCHAR PRIMARY KEY, "
            + RouteStop.COLUMN_ORDER + " INTEGER )";

    public static final String CREATE_TABLE_STATUS = "CREATE TABLE " + Status.TABLE_STATUS + " (" + Status.COLUMN_STATUS_CODE + " INTEGER PRIMARY KEY, " + Status.COLUMN_STATUS_NAME
            + " VARCHAR, " + Status.COLUMN_STATUS_TYPE + " VARCHAR )";

    public static final String CREATE_TABLE_STOP = "CREATE TABLE " + Stop.TABLE_STOP + " (" + Stop.COLUMN_STOP_ID + " INTEGER PRIMARY KEY, " + Stop.COLUMN_STOP_NAME + " VARCHAR, "
            + Stop.COLUMN_LATITUDE + " VARCHAR, " + Stop.COLUMN_LONGITUDE + " VARCHAR )";

    public static final String CREATE_TABLE_SYSTEM_CONFIG = "CREATE TABLE " + SystemConfig.TABLE_SYSTEM_CONFIG + " (" + SystemConfig.COLUMN_CONFIG_ID + " INTEGER PRIMARY KEY, "
            + SystemConfig.COLUMN_CONFIG_NAME + " VARCHAR, " + SystemConfig.COLUMN_CONFIG_VAL + " VARCHAR )";

    public static final String CREATE_TABLE_TRIP = "CREATE TABLE " + Trip.TABLE_TRIP + " (" + Trip.COLUMN_TRIP_ID + " INTEGER PRIMARY KEY, " + Trip.COLUMN_REMARKS + " VARCHAR, "
            + Trip.COLUMN_TRIP_DATE + " DATETIME, " + Trip.COLUMN_DEP_TIME + " DATETIME, " + Trip.COLUMN_ARRIVAL_TIME + " DATETIME, " + Trip.COLUMN_DURATION + " DOUBLE, "
            + Trip.COLUMN_IS_SPECIAL + " BOOLEAN, " + Trip.COLUMN_SP_NUM_PASS + " INTEGER, " + Trip.COLUMN_PURPOSE + " VARCHAR )";

    public static final String CREATE_TABLE_TRIP_SCHED = "CREATE TABLE " + TripSched.TABLE_TRIP_SCHED + " (" + TripSched.COLUMN_TRIP_SCHED_ID + " INTEGER PRIMARY KEY, "
            + TripSched.COLUMN_TRIP_NUM + " VARCHAR, " + TripSched.COLUMN_DEP_TIME + " DATETIME )";

    public static final String CREATE_TABLE_USER = "CREATE TABLE " + User.TABLE_USER + " (" + User.COLUMN_ID_NUM + " INTEGER PRIMARY KEY, " + User.COLUMN_NAME + " VARCHAR, "
            + User.COLUMN_EMAIL + " VARCHAR, " + User.COLUMN_EMERGENCY_CONTACT + " VARCHAR, " + User.COLUMN_EMERGENCY_CONTACT_NUM + " VARCHAR, " + User.COLUMN_IS_ADMIN + " BOOLEAN, "
            + User.COLUMN_ADMIN_PASSWORD + " VARCHAR )";

    public static final String CREATE_TABLE_USER_TYPE = "CREATE TABLE " + UserType.TABLE_USER_TYPE + " (" + UserType.COLUMN_TYPE_ID + " INTEGER PRIMARY KEY, " + UserType.COLUMN_TYPE_NAME
            + " VARCHAR, " + UserType.COLUMN_TYPE_PRIORITY + " INTEGER )";

    public static final String CREATE_TABLE_VEHICLE = "CREATE TABLE " + Vehicle.TABLE_VEHICLE + " (" + Vehicle.COLUMN_VEHICLE_ID + " VARCHAR PRIMARY KEY, " + Vehicle.COLUMN_VEHICLE_TYPE
            + " VARCHAR, " + Vehicle.COLUMN_CAPACITY + " INTEGER, " + Vehicle.COLUMN_IMAGE + " VARCHAR, " + Vehicle.COLUMN_PLATE_NUM + " VARCHAR, " + Vehicle.COLUMN_MODEL + " VARCHAR, "
    ...
    public static final String DELETE_TRIP = "DROP TABLE IF EXISTS " + Trip.TABLE_TRIP;
    public static final String DELETE_TRIP_SCHED = "DROP TABLE IF EXISTS " + TripSched.TABLE_TRIP_SCHED;
